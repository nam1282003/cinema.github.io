<?php
    ...
    $totalCustomers = $customerController->getTotalCustomerByType(1);
    $totalPage = floor($totalCustomers/LIMIT_ON_PAGE) + 1;
    if ($page >= $totalPage || $page < 0) {
        header("location: userManagement.php");
    }

    $normalCustomers = $customerController->getCustomerByType($page, 1);
...
<body>
    ...
    <div class="mainBody"> 
        <div class="infor">
            <div class="title">DANH SÁCH  KHÁCH HÀNG BỊ KHÓA</div>
                    ...
                    foreach ($normalCustomers as $key => $customer) {
                        echo '
                            <tr class="item">
                                ...
                                <td>
                                    <a href="lock.php?unlock_id='.$customer["id"].'"><i id="unlock" class="fa-solid fa-unlock-keyhole"></i></a> |
