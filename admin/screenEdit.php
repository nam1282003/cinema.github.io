		...
		<div class="draw-body">
			...
			<div class="content">
				<div class="button-bar-screen">
					<button class="delete" type="submit" name="delete_screening">Xóa</button>
					<button><a href="addScreen.php">Thêm suất chiếu</a></button>
					<button type="submit" name="update_screening">Lưu</button>
				</div>
				<div class="main">
