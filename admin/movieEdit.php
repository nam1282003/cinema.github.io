		...
		<div class="draw-body">
			...
			<div class="content">
				<div class="button-bar-account">
					<button type="submit "class="delete" name="delete_movie">Xóa</button>
				
					<button type="submit" name="update_movie">Lưu</button>
				</div>
				<div class="main">
					<div class="box-account">
						<div class="left">
							<li>Tên phim:</li>
							<li>Thời lượng (min):</li>
							<li>Ngày chiếu:</li>
							<li>Tình trạng:</li>
							<li>Đánh giá:</li>
						...
						<div class="image">
							...
							<label for="movie_poster">Đổi</label>
						</div>
					</div> <br>
